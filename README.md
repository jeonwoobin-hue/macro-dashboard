...
**배포 링크**: https://macro-investment-sentiment.streamlit.app
...
| 🗣️ 종목 심리분석 | 시가총액 상위 종목 PER·PBR+수급 추천 그룹, 종목토론실 여론-수익률 상관관계 | 네이버 금융(자체 스크래핑, `run_stock_pipeline.py`로 주기적 배치 갱신) |
